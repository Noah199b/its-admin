...
<link rel="stylesheet" href="${basePath}/dist/css/jquery.pagination.css">
...
<script src="${basePath}/jquery/jquery.pagination.min.js"></script>
...
<script src="${basePath}/dist/js/DateFormat.js"></script>
<!-- Editor -->
<script charset="utf-8" src="${basePath}/editor/wangEditor.min.js"></script>
</head>
