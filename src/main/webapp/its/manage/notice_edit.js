...
function doFindObjectById(id){
	var url="notice/doFindObjectById.do"
	var params={"id":id};
...
function doSaveOrUpdate(){
	...
	//根据id是否有值来判定是修改还是添加
	var updateUrl="notice/doUpdateObject.do";
	var insertUrl="notice/doSaveObject.do";
...
function getEditFormData(){
 //1.获得页面上用户输入的数据,封装为json对象(相对比较灵活)
  var params={//根据id获得数据
	  "state":$('input[name="valid"]:checked').val(),
	  "content":$("#noteId").val()
  }
